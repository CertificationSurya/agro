            ...
            <div className={`grid grid-cols-2 h-full z-20`}>
                <div className={`flex items-center h-full relative`}>
                    ...
                    <div className={`ml-24 flex flex-col gap-6`}>
                        <p className={`text-5xl font-bold`}>Learn About Farming</p>
                        <p className={`font-semibold text-gray-700`}>
                            We offer a carefully curated collection of high-quality Experts and achieving farmer to come closer. Our
                            user-friendly platform makes it easy to find what you need, and our exceptional argo based people
                            service ensures a seamless discussion. Discover the perfect
                            environment for agro based people.
                        </p>
                        <Link to={'/market'}
